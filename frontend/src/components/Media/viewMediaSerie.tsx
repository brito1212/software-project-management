...
const ViewMediaSerie: React.FC<Media> = ({
  title,
  description,
  banner,
  genres,
              ...
              <div className={styles.media_details}>
                ...
                <div className={styles.info}>
                  ...
                  <i
                    ...
                    style={{ color: "#3B57B7" }}
                  ></i>
                  <span className={styles.studio_name}>{seasons} seasons</span>
                  <i
                    className="fa-solid fa-list"
                    style={{ color: "#3B57B7" }}
                  ></i>
                  <span className={styles.studio_name}>{episodes} episodes</span>
                </div>
